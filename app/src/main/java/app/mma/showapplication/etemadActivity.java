...
public class etemadActivity extends AppCompatActivity {
    ListView list;
    Button button1;
    int sum;
    int mosition;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.etemad);
        ...
        while (n < etelaat.size()/5) {
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                    ...
                    Toast.makeText(etemadActivity.this, String.valueOf(n) + "         " + String.valueOf(a[n]) + "           " + String.valueOf(sum), Toast.LENGTH_LONG).show();
            ...
            button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent myIntent = new Intent(etemadActivity.this, resultActivity.class);
                    myIntent.putExtra("sum", sum); //Optional parameters
                    etemadActivity.this.startActivity(myIntent);
