        ...
        while (n < etelaat.size()/5) {
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                    ...
                    Toast.makeText(neoActivity.this, String.valueOf(n) + "         " + String.valueOf(a[n]) + "           " + String.valueOf(sum), Toast.LENGTH_LONG).show();
            ...
            button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent myIntent = new Intent(neoActivity.this, resultActivity.class);
                    myIntent.putExtra("sum", sum); //Optional parameters
                    neoActivity.this.startActivity(myIntent);
